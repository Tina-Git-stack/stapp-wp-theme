 ...
 */
function stapp_theme_register_block_styles() {
    // Custom Block Style: Rounded (für Image Block)
    register_block_style('core/image', array(
        'name'  => 'rounded',
        'label' => __('Abgerundet', 'stapp-theme'),
    ));
 ...
 */
function stapp_theme_block_editor_assets() {
...
add_action('enqueue_block_editor_assets', 'stapp_theme_block_editor_assets');
